...
export const typesData: any[] =  [ { type: 'ENTP', functions: ['Ne Ti', 'Ni Fe'], mode: 'Fight', bgColor: '#ff0000', bronze: 'ISFJ', silver: 'INTJ', gold: 'INFJ', copper: 'ESFP',
...
{ type: 'INFP', functions: ['Fi Ne', 'Fe Si'], mode: 'Flight', bgColor: '#22c55e', bronze: 'ESTJ', silver: 'ENFJ', gold: 'ENTJ', copper: 'ISTP',
